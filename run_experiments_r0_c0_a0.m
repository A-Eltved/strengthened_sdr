...
n = 2; % dimension of problems

disp(n)

filename = sprintf('data/wedge__seed_%i__n_%i__N_%i',seed,n,N);
...
options = struct();
probs = cell(N,1);
fprintf('Creating wedge instances...\n')
for i = 1:N
    prob = instance_generator_r0_c0_a0(n,options);
